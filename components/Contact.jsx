...
const Contact = () => {
  return (
    <section className='bg-[#74777c] w-full h-[100%] relative pb-20'>
            ...
            <div className="relative bg-[#bcc0c8] m-3 2xl:w-2/3 xl:w-3/4 2xl:ml-[20%] xl:ml-[15%] rounded-3xl shadow-lg shadow-gray-800 border-b-2 border-r-2 border-gray-500">
                <div className="flex flex-col-reverse text-center lg:flex-row flex-wrap lg:flex-nowrap lg:justify-between p-10 sm:p-14">
                    <div className="sm:text-center lg:text-left">
                        ...
                        <p className="m-3 p-5 text-base text-justify text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 lg:mx-0">
                            If you have any questions or want to work together, please feel free to contact me. I am happy to connect.
                        </p>
                        <div className="p-10 flex items-center justify-evenly">
                            <FaLinkedin size={25} className="mr-5 hover:scale-110 ease-in duration-200 hover:cursor-pointer" onClick={
                                () => {
                                    window.open('https://www.linkedin.com/in/fabioaraujo76', '_blank')
                                }
                            } />
                            <FaGithub size={25} className="mr-5 hover:scale-110 ease-in duration-200 hover:cursor-pointer" onClick={
                                () => {
                                    window.open('https://github.com/fabiodearaujo', '_blank')
                                }
                            } />
                            <FaEnvelope size={25} className="mr-5 hover:scale-110 ease-in duration-200 hover:cursor-pointer" onClick={
                                () => {
                                    window.open('https://mail.google.com/mail/u/0/?shva=1#inbox?compose=GTvVlcSHxwNHSfcCWfkcSPwCWkcmkjwflPpNCLStfmcgkJDxXTbJbJcdjgMFJCXXZrmjKhzwLKTsz')
                                }
                            }/>
                        </div>
                    </div>
